...
namespace WPIndex
{
    public class BuildInfo
    {
		...
		public class Buildinformation
		{
			...
			public string Parentbranchbuild { get; set; }
			...
			public string Qfelevel { get; set; }
			...
			public string Winphoneroot { get; set; }
			[XmlElement(ElementName = "ntrazzlemajorversion")]
			public string Ntrazzlemajorversion { get; set; }
			[XmlElement(ElementName = "ntrazzleminorversion")]
			public string Ntrazzleminorversion { get; set; }
			[XmlElement(ElementName = "ntrazzlebuildnumber")]
			public string Ntrazzlebuildnumber { get; set; }
			[XmlElement(ElementName = "ntrazzlerevisionnumber")]
			public string Ntrazzlerevisionnumber { get; set; }
		}
	}
}
